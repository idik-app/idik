    ...
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          ...
          className="relative w-full max-w-2xl rounded-2xl border border-cyan-700/50 bg-gradient-to-br from-black/60 via-gray-900/80 to-cyan-950/50 text-gray-200 p-6 overflow-hidden"
        >
          {/* Garis Scan */}
          <motion.div
            animate={{ x: ["0%", "100%"] }}
