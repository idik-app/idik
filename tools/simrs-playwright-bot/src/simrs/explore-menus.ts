...
import { isDangerousLabel, isSeparatorLabel } from "./dangerous.js";
...
async function listTopLevelMenus(page: Page): Promise<Locator[]> {
...
async function listImmediateSubmenus(
  page: Page,
  parent: Locator,
