-- Banyak deployment: app memakai Supabase project lain dari `supabase db push`, sehingga
-- pemakaian.tindakan_id tetap uuid. INSERT angka "12" gagal walau stok cukup.
-- Solusi kompatibel: jangan isi pemakaian.tindakan_id dari FIFO — tautan kasus ada di
-- cathlab_pemakaian_order.tindakan_id + cathlab_pemakaian_order_id pada baris pemakaian.
...
comment on function public.allocate_pemakaian_fifo(uuid, numeric, text, text, text, date, text) is
  'FIFO pemakaian; pemakaian.tindakan_id dibiarkan NULL — ID kasus lewat cathlab_pemakaian_order.';
