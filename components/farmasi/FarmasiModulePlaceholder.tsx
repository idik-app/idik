...
/** Placeholder modul farmasi — dipakai di /dashboard/farmasi/[...slug] dan portal /depo (sinkron). */
export default function FarmasiModulePlaceholder({ slug }: Props) {
  const key = slug.join("/");
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-6 text-center text-cyan-200">
      ...
      <p className="text-sm text-cyan-300/80">
        Modul untuk konteks{" "}
        <span className="font-semibold text-[#D4AF37]">&quot;{contextName}&quot;</span>{" "}
