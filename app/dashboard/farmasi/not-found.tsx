...
const CONTEXT_LABELS: Record<string, string> = {
  '/dashboard/farmasi/master-barang': 'Master Barang',
  '/dashboard/farmasi/master-alkes': 'Master Alkes',
  '/dashboard/farmasi/stok-opname': 'Stok Opname',
  '/dashboard/farmasi/laporan/keluar': 'Laporan Barang Keluar',
  '/dashboard/farmasi/laporan/stok-alkes': 'Laporan Stok Alkes',
};

export default function FarmasiNotFound() {
  const pathname = usePathname();
  const contextName =
    CONTEXT_LABELS[pathname] ?? pathname?.replace('/dashboard/farmasi/', '') ?? 'Farmasi';
