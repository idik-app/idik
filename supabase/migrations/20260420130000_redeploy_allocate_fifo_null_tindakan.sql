-- Ulang terapkan fungsi FIFO yang mengosongkan pemakaian.tindakan_id (INSERT NULL).
-- Berguna jika project production belum pernah menerima 20260419140000 atau fungsi ditimpa manual.
...
comment on function public.allocate_pemakaian_fifo(uuid, numeric, text, text, text, date, text) is
  'FIFO pemakaian; pemakaian.tindakan_id = NULL; tautan kasus via cathlab_pemakaian_order.';
