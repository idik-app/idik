...
const PROJECTIONS_LIST = [
  ...
  `id, tanggal, dokter, dokter_anestesi, ppds, operator, nama_pasien, nama, no_rm, no_rekam_medis, tindakan, jenis, alkes_utama, kategori, status, status_keterangan, ruangan, cath, pasien_id, is_fast_track, pasien_datang_igd, door_to_balloon, total_waktu_fast_track, fast_track_sign_in, fast_track_time_out, fast_track_sign_out, pci_report_link, pemakaian, kelas_pembiayaan, asmed, resume_erm, sjp, berkas_laporan, consumable_kelengkapan, billing_simrs, pj_laporan, operan_ranap, rs_perujuk, keterangan, diagnosa, faktor_risiko, jenis_kelamin, fluoro_time, dose, kv, ma, waktu, total_kontras, air_kerma, dap_dose, accession_no, total, krs, consumable, selisih, target_lesion, temuan_pembuluh, kesimpulan_laporan, plan_medis, ${JADWAL_TEAM_PROJECTION}, ${CEK_OBAT_PROJECTION}`,
  `id, tanggal, dokter, dokter_anestesi, ppds, nama_pasien, no_rm, tindakan, kategori, status, status_keterangan, ruangan, cath, pasien_id, is_fast_track, pasien_datang_igd, door_to_balloon, total_waktu_fast_track, fast_track_sign_in, fast_track_time_out, fast_track_sign_out, pci_report_link, pemakaian, kelas_pembiayaan, asmed, resume_erm, sjp, berkas_laporan, consumable_kelengkapan, billing_simrs, pj_laporan, operan_ranap, rs_perujuk, keterangan, diagnosa, faktor_risiko, jenis_kelamin, fluoro_time, dose, kv, ma, waktu, total_kontras, air_kerma, dap_dose, accession_no, total, krs, consumable, selisih, target_lesion, temuan_pembuluh, kesimpulan_laporan, plan_medis, ${JADWAL_TEAM_PROJECTION}, ${CEK_OBAT_PROJECTION}`,
  // Proyeksi dengan created_at (apabila tabel memilikinya)
  `id, tanggal, dokter, dokter_anestesi, ppds, operator, nama_pasien, nama, no_rm, no_rekam_medis, tindakan, jenis, alkes_utama, kategori, status, status_keterangan, ruangan, cath, pasien_id, created_at, inserted_at, updated_at, is_fast_track, pasien_datang_igd, door_to_balloon, total_waktu_fast_track, fast_track_sign_in, fast_track_time_out, fast_track_sign_out, pci_report_link, pemakaian, kelas_pembiayaan, asmed, resume_erm, sjp, berkas_laporan, consumable_kelengkapan, billing_simrs, pj_laporan, operan_ranap, rs_perujuk, keterangan, diagnosa, faktor_risiko, jenis_kelamin, fluoro_time, dose, kv, ma, waktu, total_kontras, air_kerma, dap_dose, accession_no, total, krs, consumable, selisih, target_lesion, temuan_pembuluh, kesimpulan_laporan, plan_medis, ${JADWAL_TEAM_PROJECTION}, ${CEK_OBAT_PROJECTION}`,
  // Fallback tanpa kolom cek
  `id, tanggal, dokter, dokter_anestesi, ppds, nama_pasien, no_rm, tindakan, kategori, status, status_keterangan, ruangan, cath, pasien_id, is_fast_track, pasien_datang_igd, door_to_balloon, total_waktu_fast_track, fast_track_sign_in, fast_track_time_out, fast_track_sign_out, pci_report_link, pemakaian, kelas_pembiayaan, asmed, resume_erm, sjp, berkas_laporan, consumable_kelengkapan, billing_simrs, pj_laporan, operan_ranap, rs_perujuk, keterangan, diagnosa, faktor_risiko, jenis_kelamin, fluoro_time, dose, kv, ma, waktu, total_kontras, air_kerma, dap_dose, accession_no, total, krs, consumable, selisih, target_lesion, ${JADWAL_TEAM_PROJECTION}`,
];
