...
export default function ExportReportOfficial() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-1 px-3 py-1.5 rounded-md bg-gradient-to-r from-emerald-500/90 to-green-400 text-black dark:text-white font-semibold hover:scale-105 transition"
